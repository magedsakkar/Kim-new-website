...
export const testimonials: Record<string, Testimonial[]> = {
  ...
  ar: [
    ...
    },
    {
      ...
      country: 'اليابان',
      countryFlag: '🇯🇵',
      quote: 'قدمت من اليابان وكانت لديّ مفاهيم مسبقة خاطئة عن الإسلام. تعاملت معي مؤسسة كيم بصبر وأجابت على كل سؤال بالأدلة والصدق. غادرت بقلب مليء بالاحترام.',
    },
    {
      id: '6',
      name: 'إيما مولر',
      country: 'ألمانيا',
      countryFlag: '🇩🇪',
      quote: 'كطالبة جامعية في دراسات الأديان المقارنة، كان برنامج الطلاب في كيم لا يُقدَّر بثمن. كانت النقاشات الأكاديمية عميقة ومحترمة ومضيئة حقاً.',
    },
    {
      id: '7',
      name: 'داود شين',
      ...
      countryFlag: '🇺🇸',
      quote: 'حضرت إفطار يوم الجمعة وانبهرت بدفء المجتمع. منحتني هذه التجربة فهماً جديداً تماماً للضيافة الإسلامية.',
    },
    {
      id: '8',
      name: 'بريا شارما',
      country: 'الهند',
      countryFlag: '🇮🇳',
      quote: 'كهندوسية تزور إسطنبول، كنت متوترة من دخول المسجد. جعلني فريق كيم أشعر بالراحة التامة. نهجهم في الحوار لا مثيل له فيما عشته من قبل.',
    },
  ],
};
